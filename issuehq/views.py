...
from issuehq.github import ACCESS_TOKEN
...
@root.get("/issues/<public_id>/summary")
...
@root.get("/issues/<public_id>/similar")
...
@root.post("/issues/<public_id>/chat")
